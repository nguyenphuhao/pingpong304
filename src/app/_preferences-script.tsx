...
export function PreferencesScript() {
  ...
  const code = `(function(){try{var s=localStorage.getItem("${FONT_SIZE_STORAGE_KEY}");if(s==="sm"||s==="base"||s==="lg"||s==="xl"){document.documentElement.setAttribute("${FONT_SIZE_ATTR}",s);}else{document.documentElement.setAttribute("${FONT_SIZE_ATTR}","${DEFAULT_FONT_SIZE}");}}catch(e){}})();`;
